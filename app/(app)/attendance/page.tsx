...
import { Clock, Calendar, CheckSquare, XCircle, LogIn, LogOut } from "lucide-react";
         ...
         <Card className="p-6 border-none shadow-sm flex flex-col items-center justify-center text-center">
            <div className="size-32 rounded-full border-4 border-primary/20 flex items-center justify-center relative mb-4">
               <div className="text-center">
                  <span className="text-xs font-bold text-muted-foreground uppercase">Current Session</span>
                  <p className="text-3xl font-black text-foreground tabular-nums">04:21</p>
            ...
            <p className="text-sm font-medium text-muted-foreground">Checked in at 09:00 AM</p>
         </Card>
                  ...
                  {[1, 2, 3].map((_, i) => (
                     <tr key={i} className="hover:bg-muted/30 transition-colors">
                        <td className="px-6 py-4 font-medium flex items-center gap-2">
                           <Calendar className="size-4 text-muted-foreground" /> Jan 2{4-i}, 2026
                        </td>
