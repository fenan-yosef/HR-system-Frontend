    ...
    <section className="space-y-8">
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
        <div className="space-y-2">
          <h1 className="text-4xl font-extrabold tracking-tight">People Directory</h1>
          <p className="text-muted-foreground">Manage your organization&apos;s most valuable asset.</p>
        </div>
        <div className="flex items-center gap-3">
           <div className="relative">
             <Search className="absolute left-3 top-1/2 -translate-y-1/2 size-4 text-muted-foreground" />
             <input type="text" placeholder="Search people..." className="pl-10 h-10 w-64 rounded-xl bg-card border border-border/50 text-sm focus:outline-none focus:ring-2 focus:ring-primary/20" />
           </div>
          ...
          >
            <Card className="p-6 border-none shadow-sm hover:shadow-md transition-all group relative overflow-hidden">
               ...
               <div className="flex flex-col items-center text-center">
                  ...
                  <p className="text-xs font-medium text-primary bg-primary/5 px-2 py-1 rounded-md mt-1 mb-4">Senior Designer</p>
