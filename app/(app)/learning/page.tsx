...
export default function LearningPage() {
  return (
    <section className="space-y-8">
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
        <div className="space-y-2">
          ...
          <p className="text-muted-foreground">
            Expand your skills with our curated course library.
          </p>
        </div>
      ...
      >
        <Card className="p-0 border-none shadow-sm overflow-hidden bg-linear-to-r from-primary to-primary/80 text-primary-foreground relative">
          ...
          <div className="p-8 md:p-12 relative z-10 grid md:grid-cols-2 gap-8 items-center">
            <div className="space-y-4">
              ...
              <p className="opacity-90 leading-relaxed max-w-md">
                Master the latest features in React 19, including Server
                Components, Actions, and enhanced Hooks.
              </p>
        ...
        {[
          ...
          >
            <Card className="group overflow-hidden border-none shadow-sm hover:shadow-md transition-all h-full flex flex-col">
              <div
                className={`h-40 ${course.image} relative flex items-center justify-center`}
              >
