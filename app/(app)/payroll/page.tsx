  ...
  return (
    <section className="space-y-8">
      <div className="space-y-2">
        ...
        <p className="text-muted-foreground">View your payslips, earnings history, and tax documents.</p>
      </div>

      <div className="grid gap-6 md:grid-cols-3">
        {/* Total Earnings Card */}
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
            <Card className="p-6 border-none shadow-sm h-full bg-gradient-to-br from-primary/10 to-transparent relative overflow-hidden">
               <div className="absolute top-0 right-0 p-4 opacity-10">
                  <DollarSign className="size-32 text-primary" />
               </div>
               <div className="relative z-10 flex flex-col justify-between h-full">
                  <div>
                     <span className="text-xs font-bold text-primary uppercase tracking-wider">YTD Earnings</span>
                     <h2 className="text-4xl font-black mt-2 text-foreground">$42,500.00</h2>
                  </div>
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }}>
             <Card className="p-6 border-none shadow-sm h-full flex flex-col justify-between">
               <div>
                  <span className="text-xs font-bold text-muted-foreground uppercase tracking-wider">Next Payout</span>
                  <div className="flex items-center gap-2 mt-2">
                     <Calendar className="size-5 text-primary" />
                     <h2 className="text-2xl font-bold text-foreground">Feb 28, 2026</h2>
                  </div>
               </div>
      ...
      <div className="space-y-4">
         ...
         <div className="space-y-3">
            {[
               { month: "January", year: 2026, date: "Jan 31, 2026", amount: "$3,150.00", status: "Paid" },
               { month: "December", year: 2025, date: "Dec 31, 2025", amount: "$3,150.00", status: "Paid" },
               { month: "November", year: 2025, date: "Nov 30, 2025", amount: "$3,150.00", status: "Paid" },
               { month: "October", year: 2025, date: "Oct 31, 2025", amount: "$3,150.00", status: "Paid" },
            ].map((slip, i) => (
               <motion.div 
                  key={i}
               ...
               >
                  <Card className="p-4 flex flex-col md:flex-row md:items-center justify-between gap-4 hover:shadow-md transition-shadow cursor-pointer group">
                     <div className="flex items-center gap-4">
                        ...
                        <div>
                           <p className="font-bold text-foreground">{slip.month} {slip.year} Payslip</p>
                     ...
                     <div className="flex items-center justify-between md:justify-end gap-6 w-full md:w-auto">
                        <div className="text-right">
                           <p className="font-bold text-foreground tabular-nums">{slip.amount}</p>
