...
import { Target, Star, TrendingUp, MessageSquare, Award } from "lucide-react";
  ...
  return (
    <section className="space-y-8">
      <div className="space-y-2">
        ...
        <p className="text-muted-foreground">Track your goals, reviews, and continuous improvement.</p>
      </div>

      <div className="grid gap-6 md:grid-cols-3">
         {/* Overall Rating Card */}
         <Card className="p-6 border-none shadow-sm flex flex-col items-center justify-center text-center bg-gradient-to-b from-background to-muted/20">
            ...
            <p className="text-xs text-muted-foreground mt-1">Last review: Dec 2025</p>
         </Card>
         ...
         <div className="grid gap-6">
            ...
            <Card className="p-6 border-none shadow-sm flex items-center gap-4">
               ...
               <div>
                  <p className="text-xs font-bold text-muted-foreground uppercase">Achievements</p>
      ...
      <div className="grid gap-8 md:grid-cols-2">
         ...
         <div className="space-y-4">
            ...
            <div className="space-y-4">
               {[
                  { title: "Improve Frontend Performance by 20%", due: "Mar 30", progress: 75, status: "On Track", color: "bg-emerald-500" },
                  { title: "Complete Advanced React Certification", due: "Apr 15", progress: 40, status: "At Risk", color: "bg-amber-500" },
                  { title: "Mentor Junior Developers", due: "Ongoing", progress: 90, status: "On Track", color: "bg-blue-500" },
               ].map((goal, i) => (
                  <motion.div
                     key={i}
                  ...
                  >
                     <Card className="p-4 border-none shadow-sm">
                        <div className="flex justify-between items-start mb-2">
                           ...
                           <span className={`text-[10px] uppercase font-bold px-2 py-0.5 rounded-full ${goal.status === "On Track" ? "bg-emerald-500/10 text-emerald-600" : "bg-amber-500/10 text-amber-600"}`}>
                              {goal.status}
                           </span>
                        </div>
         ...
         <div className="space-y-4">
            ...
            <div className="space-y-4">
               {[
                  { from: "Sarah Connors", role: "Product Manager", text: "Great work on the dashboard animations! They really improve the UX.", date: "2 days ago" },
                  { from: "Mike Ross", role: "Tech Lead", text: "Solid code quality on the auth module. Keep up the good documentation.", date: "1 week ago" },
               ].map((feedback, i) => (
                  <motion.div
                     key={i}
                  ...
                  >
                     <Card className="p-4 border-none shadow-sm">
                        <div className="flex gap-3">
                           ...
                           <div>
                              <p className="text-sm text-foreground italic">"{feedback.text}"</p>
                              <div className="mt-2 flex items-center gap-2">
                                 <span className="text-xs font-bold text-foreground">{feedback.from}</span>
                                 <span className="text-xs text-muted-foreground">• {feedback.role}</span>
