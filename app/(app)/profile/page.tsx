...
export default function ProfilePage() {
  ...
  const [passwordData, setPasswordData] = useState<PasswordChangeData>({ old_password: "", new_password: "" });
  ...
  if (!profile) {
    return <div className="max-w-5xl mx-auto py-8 text-center">Loading profile...</div>;
  }
