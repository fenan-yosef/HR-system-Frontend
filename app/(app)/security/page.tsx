    ...
    <section className="space-y-8">
      <div className="space-y-2">
        ...
        <p className="text-muted-foreground">
          Manage your account security and device sessions.
        </p>
      </div>

      <div className="grid gap-6 md:grid-cols-3">
        {/* Security Status */}
        <Card className="md:col-span-3 p-6 border-none shadow-sm bg-linear-to-r from-emerald-500/10 to-transparent flex items-center gap-6 border-l-4 border-l-emerald-500">
          ...
          <div>
            ...
            <p className="text-muted-foreground">
              You have completed 3 of 4 security recommendations.
            </p>
          </div>
          <div className="ml-auto hidden md:block">
            <Button
              variant="outline"
              className="border-emerald-500/50 text-emerald-600 hover:bg-emerald-500/10 font-bold"
            >
              View Checklist
            </Button>
          </div>
        ...
        >
          <Card className="p-6 border-none shadow-sm h-full flex flex-col">
            ...
            <Button
              variant="outline"
              className="w-full font-bold mt-auto border-red-200 text-red-600 hover:bg-red-50 hover:border-red-300"
            >
              Disable 2FA
            </Button>
          </Card>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <div className="flex items-center gap-2">
                      ...
                      {session.active && (
                        <span className="bg-emerald-500/10 text-emerald-600 text-[10px] font-bold px-2 py-0.5 rounded-full uppercase">
                          Current
                        </span>
                      )}
                    </div>
