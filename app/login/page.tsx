    ...
    <div className="flex min-h-svh bg-background overflow-hidden">
      ...
      <div className="flex w-full flex-col lg:w-1/2 p-6 md:p-12 relative z-10 bg-background/80 backdrop-blur-sm lg:bg-background">
        <div className="flex items-center gap-3 mb-12">
          ...
          >
            Guest Home<span className="text-primary/70"> HRMS</span>
          </motion.span>
        </div>
      ...
      {/* Right Column: Clean Internal System Panel */}
      <div className="relative hidden lg:flex lg:w-1/2 bg-primary items-center justify-center overflow-hidden">
        <div className="absolute inset-0 opacity-20" style={{ backgroundImage: "linear-gradient(135deg, rgba(255,255,255,0.18), transparent 60%)" }} />
        <div className="absolute inset-0 opacity-15" style={{ backgroundImage: "radial-gradient(circle at 20% 20%, rgba(255,255,255,0.25), transparent 45%)" }} />
        ...
        >
          <div className="flex items-center justify-center rounded-2xl bg-white/10 p-6 backdrop-blur-md border border-white/20 shadow-lg">
            <svg
              width="96"
              height="96"
              viewBox="0 0 512 512"
